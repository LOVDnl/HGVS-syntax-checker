...
\begin{frame}{Figure 3: Comparison of performance using the HGVS nomenclature validation set.}
\raggedleft
\begin{tikzpicture}
\begin{axis}[xbar,
  width=11cm,
  ...
  yticklabels={Tools perform equally (A), LOVD performs better (B),
    Unable to assess (A/B), Mutalyzer performs better (C)},
  yticklabel style={font=\small},
]
\addplot
[draw=black,fill=Mutalyzer]
coordinates
{(42.11,-1) (29.74,-2) (20.79,-3) (7.37,-4)};
%Tools perform equally: 42.11%
%HGVS outperforms Mutalyzer: 29.74%
%Unable to assess: 20.79%
%Mutalyzer outperforms HGVS: 7.37%
\end{axis}
...
[draw=black,fill=VV]
coordinates
{(63.95,-1) (27.63,-2) (8.42,-3)};
%Tools perform equally: 63.95%
%HGVS outperforms VV: 27.63%
%VV outperforms HGVS: 8.42%
\end{axis}
\end{tikzpicture}\hspace{5em}
